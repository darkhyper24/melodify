...
const ProfileDropdown = ({ setIsAuthenticated, avatarUrl }: ProfileDropdownProps) => {
    ...
    return (
        <div className="relative z-50" ref={dropdownRef}>
            <button
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full overflow-hidden bg-[#282828] hover:bg-[#3E3E3E] transition-colors duration-200"
            ...
            {isOpen && (
                <div className="fixed top-[60px] right-8 w-48 bg-[#282828] rounded-md shadow-lg z-[100] py-1 overflow-hidden">
                    <div className="px-4 py-3 border-b border-[#3E3E3E]">
                        <p className="text-sm text-white font-medium truncate">{userRole === "artist" ? "Artist Account" : "User Account"}</p>
                    </div>
                    <button
